//This class takes data entry for 3 wheeler
...
public class Data_Entry_Three extends JFrame{
    ...
    Data_Entry_Three(){
        ...
        image = new ImageIcon(getClass().getResource("three.png"));
        imageLabel = new JLabel(image);
        imageLabel.setBounds(0,-180,image.getIconWidth(),image.getIconHeight());
        

        //Header (3 WHEELER)
        LABEL = new JLabel();
        LABEL.setBounds(435,45,700,80);
        LABEL.setText("3 WHEELER");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(slot>0&&slot<11)
                {
                    ...
                    if(occupyChecker==false)
                    {
                        ...
                        HistoryBackend.setThreeWheelerCount();
                        CollectionBackend.setthreeWheelerCollection();
                        JOptionPane.showMessageDialog(null,"Successfully Data Added.", "3 WHEELER", JOptionPane.INFORMATION_MESSAGE);
                    }
                    else
                    {
                        JOptionPane.showMessageDialog(null,"Slot is already occupied. Please select other slots.", "3 WHEELER", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
                else
                {
                     JOptionPane.showMessageDialog(null,"Invalid Slot", "3 WHEELER", JOptionPane.INFORMATION_MESSAGE);
                }
...
//        Data_Entry_Three obj=new Data_Entry_Three();
//        obj.setVisible(true);
//    }
}