//This class takes data entry for 4 wheeler
...
public class Data_Entry_Four extends JFrame{
    ...
    Data_Entry_Four(){
        ...
        image = new ImageIcon(getClass().getResource("four.png"));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(slot>0&&slot<11)
                {
                    ...
                    if(occupyChecker==false)
                    {
                        ...
                        HistoryBackend.setFourWheelerCount();
                        CollectionBackend.setfourWheelerCollection();
                        JOptionPane.showMessageDialog(null,"Successfully Data Added.", "4 WHEELER", JOptionPane.INFORMATION_MESSAGE);
                    }
                    else
                    {
                        JOptionPane.showMessageDialog(null,"Slot is already occupied. Please select other slots.", "4 WHEELER", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
                else
                {
                     JOptionPane.showMessageDialog(null,"Invalid Slot", "4 WHEELER", JOptionPane.INFORMATION_MESSAGE);
                }
